...
namespace MVSPFinalProject
{
    ...
    /// </summary>
    public class Explosion1 : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public Explosion1(Game game, SpriteBatch spriteBatch,
            Vector2 position, int delay, float scale, Vector2 speed)
            : base(game)
        {
            // TODO: Construct any child components here
            this.game = game;
            this.spriteBatch = spriteBatch;
            this.tex = game.Content.Load<Texture2D>("Images/explosion");
            this.position = position;
            this.speed = speed;
            this.delay = delay;
            this.scale = scale;
            this.dimension = new Vector2(256, 300);
