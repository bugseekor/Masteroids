...
namespace MVSPFinalProject
{
    ...
    public class CollisionManager : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public CollisionManager(Game game, SpriteBatch spriteBatch,
            List<Asteroid> asteroids, Ship ship, SoundEffect explosionSound)
            : base(game)
        {
            ...
            for (int i = 0; i < asteroids.Count; i++)
            {
                ...
                if (bullet != null)
                {
                    ...
                    if (bulletRect.Intersects(asteroidRect))
                    {
                        ...
                        e1.Enabled = true;
                        e1.Visible = true;
                        score += asteroids.ElementAt(i).ScoreValue;
                ...
                {
                    explosionSound.Play();
                    Explosion2 e2 = new Explosion2(game, spriteBatch,
                        ship, 1, 3, Vector2.Zero);
                    e2.Enabled = true;
                    e2.Visible = true;
